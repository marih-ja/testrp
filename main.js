		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div id="statsGeneral">'+
					...
					'<div class="listing"><b>'+loc("Cortex baker")+'</b> <div class="price plain">'+Beautify(Game.ObjectsById[18].totalCookies)+'</div></div>'+
					'<div class="listing"><b>'+loc("You")+'</b> <div class="price plain">'+Beautify(Game.ObjectsById[19].totalCookies)+'</div></div>'+
					'<div class="listing"><b>'+loc("Bank")+'</b> <div class="price plain">'+Beautify(Game.Objects['Bank'].minigame.profit * Game.cookiesPs)+'</div></div>'+
					'<div class="listing"><b>'+loc("Cookies baked (this ascension):")+'</b> '+Beautify(Game.cookiesEarned - Game.handmadeCookies - Game.ObjectsById[0].totalCookies - Game.ObjectsById[1].totalCookies - Game.ObjectsById[2].totalCookies - Game.ObjectsById[3].totalCookies - Game.ObjectsById[4].totalCookies - Game.ObjectsById[5].totalCookies - Game.ObjectsById[6].totalCookies - Game.ObjectsById[7].totalCookies - Game.ObjectsById[8].totalCookies - Game.ObjectsById[9].totalCookies - Game.ObjectsById[10].totalCookies - Game.ObjectsById[11].totalCookies - Game.ObjectsById[12].totalCookies - Game.ObjectsById[13].totalCookies - Game.ObjectsById[14].totalCookies - Game.ObjectsById[15].totalCookies - Game.ObjectsById[16].totalCookies - Game.ObjectsById[17].totalCookies - Game.ObjectsById[18].totalCookies - Game.ObjectsById[19].totalCookies)+'</div>'+
